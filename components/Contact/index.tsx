...
const Contact = () => {
  return (
    <section
      id="contact"
      className="overflow-hidden bg-white py-16 dark:bg-gray-800 md:py-20 lg:py-28"
    >
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div
              className="wow fadeInUp mb-12 bg-primary/[3%] py-11 px-8 dark:bg-gray-900 sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]"
              data-wow-delay=".15s
              "
            >
